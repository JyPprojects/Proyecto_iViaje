...
$sql_info_viaje="SELECT nombre_viaje, pais, fecha_inicio, fecha_fin, bote FROM viajes INNER JOIN viajes_usuario on viajes.idviaje=viajes_usuario.id_viaje WHERE viajes.idviaje=$_SESSION[id_viaje]";
...
$sql3="SELECT id_necesidad_viaje, id_usuario, necesidad_viaje FROM necesidades_viaje WHERE id_necesidad = 3 AND id_viaje = $_SESSION[id_viaje]";
$query3=mysqli_query($conexion, $sql3);

$sql4="SELECT id_necesidad_viaje, id_usuario, necesidad_viaje FROM necesidades_viaje WHERE id_necesidad = 4 AND id_viaje = $_SESSION[id_viaje]";
